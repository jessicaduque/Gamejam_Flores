...
public class AudioManager : Singleton<AudioManager>
{
    ...
    {
        SomSO sound = GetMusic(soundName);
    ...
    private void SetupCurrentMusicSource(AudioSource currentMusicSource, SomSO sound)
    {
    ...
    private SomSO GetSFX(string soundName)
    {
        SomSO sound = sfx.Find(music => music.soundName == soundName);
